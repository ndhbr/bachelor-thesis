...
negative Neigung, während eins einer völligen Zustimmung entspricht. Die
restlichen Noten bilden wie gewohnt lineare Zwischenwerte.
...
bzw. Aufgabe unlösbar erscheinen, gibt es am Ende jeder Aufgabe einen
...
Programm wieder. Die Aufgabe des Teilnehmenden ist es nun den Namen in folgenden
...
Programms nach der gewünschten Größe bzw. Höhe der Pyramide gefragt. Nach
Eingabe eines gültigen Werts liefert das Skript, ausgegeben mit Raute-Zeichen,
die linke Seite einer klassischen Super Mario Pyramide. Die Ausgabe der gelösten
Aufgabe sieht beispielhaft so aus:
...
Studienteilnehmenden erhalten zu Beginn des Probelaufs einen Link zur Übersicht
der benötigten Anleitungen in Tutors.
