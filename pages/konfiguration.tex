...
entwickelt Herr Huber hierfür ein Template-Repository.
...
programmieren. Neben einer Dateiübersicht, einem Text\-editor und einer Konsole
...
Quelltext-Debugger, eine lokale Key-Value-Datenbank, private Umgebungsvariablen,
...
welche sich in dem Verzeichnis namens \texttt{node\_modules} befinden.
Normalerweise wird der Ordner im Kontext von externen Modulen der
...
diverse Tools, welche den Studierenden bei der Einrichtung und Verwaltung der 
...
dem übergebenen Namen und lädt es schließlich über den Befehl \code{git clone}
...
Nach der Ausführung des Einrichtungsskripts, wird automatisch eine neue
...
GitHub zu verwenden, muss der öffentliche Schlüssel noch zum GitHub-Profil des 
Studierenden hinzugefügt werden. Hierfür enthält das Starter-Template ein
